...
@section('title',$tdk->title.'《'.$novel->name.'》'.$novel->name.'[TXT小说下载] - '.$tdk->title)
@section('keywords', $tdk->title.$novel->keywords)
@section('description',$tdk->title.$novel->description)
